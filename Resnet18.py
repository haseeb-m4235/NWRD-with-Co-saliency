...
weights_directory = 'resnet18_curriculum_patches_300_patch'
graph_file = 'C:\\Users\\hasee\\Desktop\\Semester Internship\\FineLine\\BInaryClassifier\\Resnet\\simsiam_resnet18_curriculum_patches_300_patch_graph.csv'
...
rust, non_rust = get_label('C:\\Users\\hasee\\Desktop\\Semester Internship\\300\\train')

random.seed(4)
random.shuffle(non_rust)
non_rust = non_rust[:2000]
...
weight_loc = f"C:\\Users\\hasee\\Desktop\\Semester Internship\\FineLine\\BInaryClassifier\\Resnet\\{weights_directory}"
