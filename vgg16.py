...
weights_directory = 'vgg16_128_patch'
graph_file = 'C:\\Users\\hasee\\Desktop\\Semester Internship\\FineLine\\BInaryClassifier\\Resnet\\vgg16_128_patch_graph.csv'
...
rust, non_rust = get_label('C:\\Users\\hasee\\Desktop\\Semester Internship\\128\\train')

random.seed(4)
random.shuffle(non_rust)
non_rust = non_rust[:3000]
